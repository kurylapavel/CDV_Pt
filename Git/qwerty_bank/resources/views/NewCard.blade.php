        ...
        {{-- <div class="box">
            <form action="newCard" method = "post" name="form">
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Сard expiry date</label>
                    <select name="expiry"  class="form-control" id="exampleFormControlSelect1" required>
                ...
                <br>
                @csrf
                <button type="submit" class="btn btn-outline-success">Create card</button>
            </form>  --}}
